        ...
        <form wire:submit="save" class="space-y-20">
            ...
            <div class="grid md:grid-cols-2 gap-20">
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-12 py-8 border border-olive/30 rounded-none focus:border-olive focus:ring-2 focus:ring-olive bg-white text-olive placeholder-olive/50"
                    >
            ...
            <div>
                ...
                <textarea 
                    ...
                    wire:model="message"
                    rows="4"
                    class="w-full px-12 py-8 border border-olive/30 rounded-none focus:border-olive focus:ring-2 focus:ring-olive bg-white text-olive placeholder-olive/50 resize-none"
                ></textarea>
            </div>
